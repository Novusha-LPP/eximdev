  ...
  useEffect(() => {
    if (isOpen) {
      const initialData = JSON.parse(JSON.stringify(selectedCharges)).map(charge => {
        ...
        const costIsTds = (charge.cost && charge.cost.isTds !== undefined)
          ? charge.cost.isTds
        ...
        const revTdsCat = charge.revenue?.tdsCategory || costTdsCat || '94C';
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          ...
                                          setPurchaseBookData(() => {
                                            ...
                                            return {
                                              partyName: partyName,
                                              chargeHeading: row.category === 'Margin' ? (partyName || '') : `NEW - ${partyName}`,
                                              partyDetails,
                                              amount: amt,
                                              basicAmount: basic,
                                              gstAmount: totalGst,
