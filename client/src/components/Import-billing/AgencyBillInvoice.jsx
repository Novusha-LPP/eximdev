            ...
            <div className="abi-page" ref={printableRef}>
                ...
                <div className="abi-master-grid">
                    ...
                    <div className="abi-grid-col abi-grid-left">
                        ...
                        <div className="abi-grid-row"><div className="abi-lbl">MBL No.</div><div className="abi-sep">:</div><div className="abi-val">{(Array.isArray(jobData.mbl_details) && jobData.mbl_details.length > 0 ? jobData.mbl_details.map(m => (typeof m === 'object' ? m?.mbl_no : m)).filter(Boolean).join(", ") : jobData.awb_bl_no) || ""}</div></div>
                        <div className="abi-grid-row"><div className="abi-lbl">Date</div><div className="abi-sep">:</div><div className="abi-val">{(Array.isArray(jobData.mbl_details) && jobData.mbl_details.length > 0 ? jobData.mbl_details.map(m => formatDate(typeof m === 'object' ? m?.mbl_date : "")).filter(Boolean).join(", ") : formatDate(jobData.awb_bl_date)) || ""}</div></div>

                        <div className="abi-grid-row"><div className="abi-lbl">HBL No.</div><div className="abi-sep">:</div><div className="abi-val">{(Array.isArray(jobData.hbl_details) && jobData.hbl_details.length > 0 ? jobData.hbl_details.map(h => (typeof h === 'object' ? h?.hbl_no : h)).filter(Boolean).join(", ") : (jobData.hawb_hbl_no || jobData.hbl_no)) || ""}</div></div>
                        <div className="abi-grid-row"><div className="abi-lbl">Date</div><div className="abi-sep">:</div><div className="abi-val">{(Array.isArray(jobData.hbl_details) && jobData.hbl_details.length > 0 ? jobData.hbl_details.map(h => formatDate(typeof h === 'object' ? h?.hbl_date : "")).filter(Boolean).join(", ") : formatDate(jobData.hawb_hbl_date || jobData.hbl_date)) || ""}</div></div>
                ...
                <div className="abi-full-box">
                    <div className="abi-full-row">
                        ...
                        <div>: {editableFields.importerName || jobData.importer || ""}</div>
                    </div>
                    {mode !== 'AIR' && (
                        <div className="abi-full-row">
