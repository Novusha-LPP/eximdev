              ...
              <Paper variant="outlined" sx={{ p: 4, position: 'relative', overflow: 'hidden', backgroundColor: '#fff', borderRadius: 2 }}>
                ...
                <Typography 
                  ...
                  sx={{ 
                    ...
                    fontWeight: 900,
                    pointerEvents: 'none',
                    color: selectedPaymentRequest.status === 'Paid' ? '#2e7d32' : '#fbc02d',
                    zIndex: 0
                  }}
                >
                  {selectedPaymentRequest.status === 'Paid' ? 'PAID' : 'PENDING'}
                </Typography>
                ...
                <Box sx={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 4 }}>
                    <Box>
                      <Typography variant="h5" color="primary" fontWeight="bold">EXIMDEV PVT LTD.</Typography>
