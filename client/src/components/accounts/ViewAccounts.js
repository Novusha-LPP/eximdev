...
const MasterEntriesView = () => {
  ...
  const getStatusIcon = (daysUntilDue) => {
      ...
      >
        <CardContent sx={{ p: 3 }}>
          ...
          >
            ...
            {selectedMasterType && (
              <Chip
                icon={<Badge badgeContent={filteredEntries.length} color="primary" />}
          ...
          {filteredEntries.length === 0 ? (
            <Box sx={{ p: 8, textAlign: 'center' }}>
              ...
              <Typography color="text.secondary">
                {searchTerm ? 'Try adjusting your search terms' : 'No entries found for this master type'}
              </Typography>
            </Box>
          ) : (
      ...
      {!selectedMasterType && (
        ...
        >
          ...
          <Typography color="text.secondary" sx={{ 
            ...
            Choose a master type from the dropdown above to view and manage your business records in a clean, organized format.
          </Typography>
        </Card>
      )}
    </Box>
