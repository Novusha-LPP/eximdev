...
function Stage1PolicyProposal({ formData, handleChange, handleQuotationChange, handleSelectL1, handleRemoveQuotation, handleAddQuotation, handleRegistrationBlur, formatDateValue, isView }) {
  return (
    <>
      {/* Vehicle Details */}
      <Paper sx={{ p: 3, mb: 3 }}>
