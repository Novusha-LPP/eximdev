...
const DocumentationDashboard = () => {
    ...
    const { data: rawData, loading } = useLiveAnalytics('documentation', startDate, endDate, importer, selectedBranch, selectedCategory);
    ...
    const pending = data.summary.documentation_pending || 0;
    ...
    return (
        <div className={`tv-dashboard-wrapper tv-severity-${severity}`}>
            ...
            <div className="tv-center">
                <div className="tv-label">Alvision Pulse — Documentation</div>
