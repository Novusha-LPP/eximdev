          ...
          if (todayRecord) {
            ...
            if (matches) {
              processed.push({
                ...
                leaveStatus: String(todayRecord.approval_status || (s === 'pending_leave' ? 'pending' : todayRecord.status || '')).toLowerCase(),
          ...
          <div className="aam-body">
            {loading ? (
              ...
              <>
                ...
                {type === 'leave' ? (
                  <>
                    <div className="aam-leave-table-head">
                      <span>Name</span>
                      <span>Reason</span>
                      <span>Status</span>
                    </div>
                    {filtered.map(emp => (
                      ...
                      >
                        <div className="aam-leave-person">
                          ...
                          <div className="aam-dept">{emp.organization} · {emp.team}</div>
                        </div>
                        <div className="aam-leave-reason">
                          {emp.leaveReason || emp.leaveType || 'Leave applied'}
                        </div>
                        <div className={`aam-leave-status ${emp.leaveStatus === 'approved' ? 'approved' : 'pending'}`}>
