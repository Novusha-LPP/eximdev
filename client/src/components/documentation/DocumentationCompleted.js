...
function DocumentationCompleted() {
  ...
  // Use context for searchQuery, selectedImporter, and currentPage for documentation completed tab
  const {
    searchQuery,
    setSearchQuery,
    selectedImporter,
...
export default React.memo(DocumentationCompleted);
