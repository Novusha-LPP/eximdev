                      ...
                      >
                        <FileUpload
                          ...
                          onFilesUploaded={(urls) => {
                            ...
                            const originalIndex =
                              formik.values.cth_documents.findIndex(
                                (doc) =>
                                  doc.document_code ===
                        ...
                        <ImagePreview
                          ...
                          onDeleteImage={(deleteIndex) => {
                            ...
                            updatedDocuments[originalIndex].url.splice(
                              deleteIndex,
                              1
                            );
                            formik.setFieldValue(
                          ...
                          {!isDisabled && (
                            <>
                              ...
                              <span
                                ...
                                onClick={() =>
                                  handleOpenDialog(document, false)
                                }
                              >
                                <i
                      ...
                      <Col xs={12} lg={4}>
                        <TextField
                          ...
                          name={`cth_documents[${formik.values.cth_documents.findIndex(
                            (doc) =>
                              doc.document_code === document.document_code &&
                              doc.document_name === document.document_name
                          )}].irn`}
                          value={document.irn || ""}
                          onChange={(e) => {
                            ...
                            updatedDocuments[originalIndex].irn =
                              e.target.value;
                            formik.setFieldValue(
                              "cth_documents",
                              updatedDocuments
                        ...
                        <div>
                          <Checkbox
                            ...
                            onChange={() => {
                              ...
                              if (
                                updatedDocuments[originalIndex]
                                  .document_check_date
                              ) {
                        ...
                        {user.role === "Admin" && (
                          <TextField
                            ...
                            onChange={(e) => {
                              ...
                              updatedDocuments[
                                originalIndex
                              ].document_check_date = e.target.value;
                              formik.setFieldValue(
                                "cth_documents",
                                updatedDocuments
                              );
