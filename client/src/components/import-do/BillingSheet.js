  ...
  const columns = [
    {
      ...
      Cell: ({ cell }) => {
        ...
        return (
          <div
            style={{
              // If the row matches the selected ID, give it a highlight, otherwise use dynamic colors
              backgroundColor:
                selectedJobId === _id ? "#ffffcc" : bgColor || "transparent",
              textAlign: "center",
              cursor: "pointer",
              color: selectedJobId === _id ? "blue" : textColor,
            }}
            onClick={() => {
