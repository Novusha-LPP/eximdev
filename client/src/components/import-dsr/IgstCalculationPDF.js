...
const IgstCalculationPDF = ({
  ...
  const generateIgstCalculationPdf = async () => {
    try {
      ...
      const netWeightAsPerPL = parseFloat(
        container.net_weight_as_per_PL_document
      );
      const netWeight =
        parseFloat(jobData.job_net_weight) || parseFloat(container.net_weight);
      ...
      addCell(
        margin + labelWidth + colonWidth,
        yPos,
        consigneeWidth - labelWidth - colonWidth,
        35,
        jobData.importer || "AIA ENGINEERING LTD",
        "center",
        12
      );
      ...
      addCell(
        margin + labelWidth + colonWidth + dataWidth,
        yPos,
        dataWidth,
        35,
        formatDate(jobData.be_date) || "",
        "center",
        12
      );
      ...
      addCell(
        ...
        dataWidth,
        35,
        netWeightAsPerPLInMTS.toFixed(3),
        "center",
        12
      );
      addCell(
      ...
      addCell(
        margin,
        yPos,
        fullWidth - valueWidth - decimalWidth,
        35,
      ...
      addCell(
        margin + fullWidth - valueWidth - decimalWidth,
        yPos,
        valueWidth,
        35,
        Math.floor(assessableValue).toString(),
        "right",
        12
      );
      addCell(
        margin + fullWidth - decimalWidth,
        yPos,
        decimalWidth,
        35,
        "00",
      ...
      addCell(
        margin,
        yPos,
        (fullWidth - valueWidth - decimalWidth) / 2,
        35,
        "IGST",
        "center",
        12
      ...
      addCell(
        margin + (fullWidth - valueWidth - decimalWidth) / 2,
        yPos,
        (fullWidth - valueWidth - decimalWidth) / 2,
        35,
        igstRate + "%",
