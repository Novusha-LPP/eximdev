# AlVision EXIM Database — Comprehensive Domain Architecture & Schema Brain Reference

> **Document Type**: Loss-Less Brain Reference File (LLM Knowledge Store)
> **Source File**: `EXIM_Database_Reference.md`
> **Purpose**: This document serves as the complete, zero-loss domain reference guide for the AlVision EXIM database. It incorporates all 16 architecture sections, operational milestones, schema tables, CRM collections, KYC workflows, Master directories, HR attendance subsystems (22 collections), governance matrices, consignment movement steps, and business terminology.
