...
const emptyYardDirectorySchema = new mongoose.Schema({
...
const EmptyYardDirectoryModel = mongoose.model("EmptyYardDirectory", emptyYardDirectorySchema, "empty_yard_directories");
export default EmptyYardDirectoryModel;
