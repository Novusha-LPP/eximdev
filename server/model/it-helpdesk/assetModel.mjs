...
const assetSchema = new mongoose.Schema({
  ...
  approval_stage: {
    type: String,
    enum: ["Admin Approval", "Accounts Approval", "IT Correction", "Completed", "Rejected"],
    default: "Admin Approval",
    index: true,
  },
  approval_status: {
    type: String,
    enum: ["Pending Admin Approval", "Pending Accounts Approval", "Returned to IT", "Completed", "Rejected"],
  ...
  admin_verifications: [
    {
      ...
      name: String,
      role: String,
      action: { type: String, default: "Admin Verified" },
      remarks: String,
      approval_cycle: { type: Number, default: 1 },
  ...
  accounts_verifications: [
    {
      ...
      name: String,
      role: String,
      action: { type: String, default: "Accounts Approved" },
      remarks: String,
      approval_cycle: { type: Number, default: 1 },
      timestamp: { type: Date, default: Date.now },
    },
