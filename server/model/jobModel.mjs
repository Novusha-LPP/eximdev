...
const jobSchema = new mongoose.Schema({
  ...
  esanchit_remark_box: { type: Boolean, default: false },
  documentation_remark_box: { type: Boolean, default: false },
  remark_esanchit_input: { type: String, trim: true },
  remark_documentation_input: { type: String, trim: true },
