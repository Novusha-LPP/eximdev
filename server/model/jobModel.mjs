...
const jobSchema = new mongoose.Schema({
  ...
  dsr_queries: [{ query: { type: String }, current_module: { type: String }, select_module: { type: String }, reply: { type: String }, resolved: { type: Boolean, default: false }, resolved_by: {type: String} }],
