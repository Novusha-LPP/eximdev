...
const itemDutyNotificationSchema = new mongoose.Schema(
  {
    section: {
      type: String,
      default: "B",
    ...
    duty_head: {
      ...
      uppercase: true,
      index: true
    }, // BCD, CVD_05, SWS, SAD, IGST, G. CESS, ADD, CVD, SG, T. VALUE
    cth_code: {
      type: String,
      trim: true,
      default: "ALL",
...
itemDutyNotificationSchema.index(
  { notn_no: 1, notn_sno: 1, duty_head: 1, cth_code: 1 },
  { unique: true }
);

const ItemDutyNotificationModel = mongoose.model(
  "ItemDutyNotification",
  itemDutyNotificationSchema
);

export default ItemDutyNotificationModel;
