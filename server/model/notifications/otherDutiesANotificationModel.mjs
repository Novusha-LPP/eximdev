...
const otherDutiesANotificationSchema = new mongoose.Schema(
  {
    section: {
      type: String,
      default: "D",
    ...
    duty_head: {
      ...
      uppercase: true,
      index: true
    }, // OTHCUS, OTHCVD, PETR CUS, INFRA CES, CUS CVD
    cth_code: {
      type: String,
      trim: true,
      default: "ALL",
...
otherDutiesANotificationSchema.index(
  { notn_no: 1, notn_sno: 1, duty_head: 1, cth_code: 1 },
  { unique: true }
);

const OtherDutiesANotificationModel = mongoose.model(
  "OtherDutiesANotification",
  otherDutiesANotificationSchema
);

export default OtherDutiesANotificationModel;
