...
router.get("/api/view-completed-kyc", async (req, res) => {
  try {
    const data = await CustomerKycModel.find({
      ...
      "_id name_of_individual category status iec_no approval approved_by financial_details_approved financial_details_approved_by remarks approvedAt updatedAt createdAt"
    );
