...
router.get('/pending-leaves/count', attendanceAuthBridge, requireRole(['ADMIN', 'HOD']), hodCtrl.getPendingLeavesCount);
...
router.get('/payroll', attendanceAuthBridge, requireRole(['ADMIN', 'HOD']), attendanceCtrl.getPayrollData);
