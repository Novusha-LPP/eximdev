...
const WorkingDayEngine = require('../services/WorkingDayEngine');
...
exports.lockMonthAttendance = async (req, res) => {
    try {
...
exports.getPayrollLocks = async (req, res) => {
    try {
        const companyId = req.user.company_id;
        const result = await QueryBuilder.build(
            PayrollLock,
...
exports.togglePayrollLock = async (req, res) => {
    try {
...
exports.updateEmployeeProfileAdmin = async (req, res) => {
    try {
        const { id } = req.params;
