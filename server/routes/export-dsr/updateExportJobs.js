...
router.patch('/:year/:job_no/fields', auditMiddleware('Job'), async (req, res) => {
  try {
    const { year, job_no } = req.params;
...
// Update documents
router.put('/:year/:job_no/documents', auditMiddleware('Job'), async (req, res) => {
  try {
    const { year, job_no } = req.params;
...
// Update containers
router.put('/:year/:job_no/containers', auditMiddleware('Job'), async (req, res) => {
  try {
    const { year, job_no } = req.params;
