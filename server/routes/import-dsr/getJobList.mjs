...
const defaultFields = `
  ...
  port_of_reporting type_of_b_e consignment_type shipping_line_airline bill_date out_of_charge pcv_date delivery_date do_completed do_validity rail_out_date cth_documents
`;
