...
const defaultFields = `
  ...
  gateway_igm_date discharge_date detailed_status be_no be_date loading_port free_time is_og_doc_recieved og_doc_recieved_date do_shipping_line_invoice RMS
